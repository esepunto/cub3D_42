...
/*   Updated: 2020/11/25 12:52:09 by ssacrist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/	
	...
	//Init gameloop(draw a whole frame and read the input)

//	while(done())
//	{
		for(int x = 0; x < a->fconf.yrendersize; x++)
		{
			//calculate ray position and direction
			a->rayc.xcamera = 2 * x / (double)a->fconf.yrendersize - 1;//x-coordinate in camera space
...
//			verLine(x, a->rayc.drawstart, a->rayc.drawend, color);
			mlx_pixel_put(a->mlibx.mlx, a->mlibx.win, x, x, color);
//			printf("color: %d\n", a->rayc.drawstart);			
		}
/*		
